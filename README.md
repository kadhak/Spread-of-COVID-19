...
considering the contribution to the epidemic dynamics by public health interventions factors, such as the government locked down the cities, took measures to track and quarantine people who have close contact with confirmed cases, advocated citizens to keep social distances and wash hands frequently, etc., we further used an Generalized SEIR model for COVID-19 estimation.
